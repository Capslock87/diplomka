    ...
    function renderCart() {
        ...
        const html = items.map((item, index) => `
            <div class="cart-item" data-id="${item.id}" data-size="${item.size}">
                <img src="${item.image}" alt="${window.getLocalizedName(item)}" class="cart-item-img">
                <div class="cart-item-info">
                    <div class="cart-item-header">
                        <div class="cart-item-title">${window.getLocalizedName(item)}</div>
                        <button class="cart-item-remove" aria-label="${translations[window.currentLang].remove}">&times;</button>
                    </div>
                    <div class="cart-item-details">
                        ${translations[window.currentLang].productSize} ${item.size}
                    </div>
